...
- Balanced ternary, where the allowed trit values are -1, 0, and +1
- Programming on my TI-84 using its language similar to BASIC
- Assembly languages and binary machine code instructions
- The real-life ternary computer known as [Setun](https://en.wikipedia.org/wiki/Setun)

This isn't meant to be easy or performant, just interesting.
...
Ideally, one of these will be sufficient to represent my character set using an encoding system along the same lines as ASCII.
...
I kind of like 5 since 243 is a decent number of total values (almost 1 byte) and 5 is also prime, which might make things interesting and difficult.
